...
import net.dasturv.dasturvbrews.screen.slot.ModCupSlot;
import net.dasturv.dasturvbrews.screen.slot.ModResultSlot;
...
public class KettleScreenHandler extends ScreenHandler {
    ...
    public KettleScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate) {
        ...
        this.addSlot(new ModCupSlot(inventory, 1, 106, 46));
        this.addSlot(new ModResultSlot(inventory, 2, 106, 25));
